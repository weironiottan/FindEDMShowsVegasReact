...
function Header() {
    ...
    return(
    <>
    <section className="hero-section bg-auto bg-center bg-no-repeat  h-2/5 w-full flex flex-col justify-between"
        style={{backgroundImage: `url(${heroImage})` }}>
            ...
            filter drop-shadow-3xl  text-base sm:text-7xl tracking-widest uppercase font-mono text-white">find edm shows in vegas</div>
